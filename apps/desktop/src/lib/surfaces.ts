...
export const SURFACES: readonly Surface[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "local.console.login", label: "Sign in to the console", hint: "Mints a single-use code you paste into the console; the console never gets the platform key" },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "cluster.console.login", label: "Sign in to the console", hint: "Mints a single-use code you paste into the console; the console never gets the platform key" },
