...
export const SURFACES: readonly Surface[] = [
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "cluster.channel-token", label: "Mail adapter token", quiet: true, hint: "Mint or inspect the token the mail adapter authenticates with" },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: "dev.release-accept", label: "Release gate evaluator", quiet: true },
      { id: "dev.two-release-approval-e2e", label: "Two releases, one Slack app" },
      { id: "dev.cluster-upgrade-matrix", label: "Cluster upgrade matrix" },
      { id: "dev.upgrade-drill", label: "Interrupted upgrade recovery" },
      { id: "dev.recovery-drill", label: "Worker and runner recovery" },
      { id: "dev.restore-drill", label: "Restore from backup" },
      { id: "dev.lease-expiry-cluster-proof", label: "Lease expiry reclaim" },
