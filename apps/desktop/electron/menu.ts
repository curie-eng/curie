  ...
  const template: MenuItemConstructorOptions[] = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: "Resources", accelerator: "CmdOrCtrl+2", click: go(getWin, "resources") },
        { label: "Canvas", accelerator: "CmdOrCtrl+3", click: go(getWin, "canvas") },
        { label: "Commands", accelerator: "CmdOrCtrl+4", click: go(getWin, "commands") },
        { label: "Activity", accelerator: "CmdOrCtrl+5", click: go(getWin, "activity") },
      ],
    },
    {
      label: "View",
