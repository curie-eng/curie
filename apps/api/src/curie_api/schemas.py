...
class ApprovalResumeCancel(_RecoveryRequest):
    """One administrative cancellation of an owed resume (the tombstone)."""
...
class ApprovalResumeCancelOut(BaseModel):
    """The RECORDED outcome of an administrative resume cancellation."""
