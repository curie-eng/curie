"""Migration 0053 adds curie.provider_installations (#2909)."""
...
def test_0053_revises_0052() -> None:
    script = ScriptDirectory.from_config(_config())
    revision = script.get_revision("0053")
    assert revision is not None
    assert revision.down_revision == "0052"


def test_0053_round_trip_creates_and_drops_provider_installations(
    ...
    try:
        ...
        # The FK targets from 0051/0052 must outlive the downgrade.
