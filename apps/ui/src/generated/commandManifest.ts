      ...
      "subcommands": [
        ...
        },
        {
          ...
          "args": [
            ...
            {
              "global": false,
              "help": "The worker's composed key: kind[:identity]:channel:thread-ts, each part percent-encoded, identity only when not the default Slack app (e.g. slack:C0EXAMPLE1:1700000000.000100)",
              "id": "thread_key",
              "long": "thread-key",
              "positional": false,
              "required": true
