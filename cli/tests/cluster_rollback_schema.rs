...
/// the 0045 floor and continues through feature train head 0054, so the
/// pending live migrations are 0045 through 0054 and the upgrade applies.
#[test]
fn v091_source_upgrades_through_the_packaged_chart_graph() {
    ...
    assert_eq!(target.schema_head, "0054");
