...
def _platform_tool_policy_server_message(pattern: str, server: str) -> str:
    ...
    return (
        ...
        "they are outside toolPolicy scope entirely: the platform paths they carry "
        "(approval, publication and channel memory) are always reachable, and no "
        "policy can add to or remove from them. This pattern is therefore inert at "
