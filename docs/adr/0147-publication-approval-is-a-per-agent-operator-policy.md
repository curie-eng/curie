...
[issue #2575](https://github.com/curie-eng/curie/issues/2575). Under
...
another ADR set on incident evidence it was an explicit one. The realizing code
paths are named above.
