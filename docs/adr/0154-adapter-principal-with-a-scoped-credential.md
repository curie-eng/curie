# 154. A channel adapter is a principal, and its credential is scoped to what an adapter does

Date: 2026-09-17

Status: Accepted

Partially amended by [ADR 0156](0156-adapter-principal-with-a-scoped-credential.md), solely the sender authentication trust boundary clarification in Decision 3.
