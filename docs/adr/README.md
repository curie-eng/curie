...
| 0155 | [A channel adapter is a principal, and its credential is scoped to what an adapter does](0155-adapter-principal-with-a-scoped-credential.md) | Accepted |
