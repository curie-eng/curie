...
kind: CLEAN
impls: 55 outputs behind one trait
...
> **Kind:** CLEAN &nbsp;·&nbsp; **Implementations today:** 55 outputs behind one trait &nbsp;·&nbsp; **Swap-readiness grade:** not separately graded
...
55 `CliOutput` implementations, all in the CLI crate, grouped by owning module:
