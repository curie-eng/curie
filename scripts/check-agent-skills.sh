...
VALID_SKILLS=(
  ...
  "examples/mean-tester/evals/fixtures/answers-plainly/bundle/skills/answers-plainly"
  "examples/mean-tester/evals/fixtures/asks-for-approval-honestly/bundle/skills/asks-for-approval-honestly"
  "examples/mean-tester/evals/fixtures/claims-an-action-it-only-asked-for/bundle/skills/claims-an-action-it-only-asked-for"
  "examples/mean-tester/evals/fixtures/failure-preamble-on-a-good-answer/bundle/skills/failure-preamble-on-a-good-answer"
  "examples/mean-tester/evals/fixtures/invents-a-cause/bundle/skills/invents-a-cause"
  "examples/mean-tester/evals/fixtures/invents-a-file/bundle/skills/invents-a-file"
  "examples/mean-tester/evals/fixtures/never-answers/bundle/skills/never-answers"
